...
class TocMachine(GraphMachine):
    ...
    def on_enter_start(self, event):
        print("I'm entering start")
        reply_token = event.reply_token
        send_text_message(reply_token, "你更喜歡 (i)獨處 (e)與他人相處?\nPlease \"I\" or \"E\"")

    def on_enter_I(self, event):
        print("I'm entering I")
        reply_token = event.reply_token
        send_text_message(reply_token, "學習新鮮事物時，你更喜歡 (n)瞭解概念與理論 (s)註重實際用途？\nPlease \"N\" or \"S\"")
    ...
    def on_enter_IN(self, event):
        ...
        reply_token = event.reply_token
        send_text_message(reply_token, "當你在做決策時，你比較在乎 (t)重視邏輯與公平 (f)重視感情與和睦？\nPlease \"T\" or \"F\"")
    ...
    def on_enter_INT(self, event):
        ...
        reply_token = event.reply_token
        send_text_message(reply_token, "你的生活方式更傾向於 (j)先工作，再玩耍。做事著重結果 (p)先玩耍，再工作。做事享受過程？\nPlease \"J\" or \"P\"")
